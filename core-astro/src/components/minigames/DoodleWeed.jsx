...
export default function DoodleWeed({ onExit }) {
    ...
    const endGame = () => {
        ...
        if (stateRef.current.score > 0) {
            useStore.setState(state => ({ balance: state.balance + Math.floor(stateRef.current.score * 0.1) }));
        ...
        >
            <div className="header-nav">
                ...
                <div className="score-display">
                    <Coins size={16} color="#ffcc00" /> {Math.floor(score * 0.1)} (Sc: {score})
                </div>
            </div>
            ...
            <div className="game-container">
                ...
                {gameState === 'GAMEOVER' && (
                    <div className="overlay-menu">
                        <h1>CHUTE</h1>
                        <p>Score: {score}</p>
                        <p>Gains: <strong style={{ color: '#ffcc00' }}>{Math.floor(score * 0.1)} <NeonIcon name="coin-gold" size={18} /></strong></p>
                ...
                <div className="play-area">
                    ...
                    {(gameState === 'PLAYING' || gameState === 'GAMEOVER') && (
                        ...
                        >
                            <img src="/images/icons/items/rikart-doodle-weed.png" alt="Yoshit" className="yoshi-sprite-doodle" />
                        </div>
                    )}
                </div>
            </div >
