...
export default function PageWaluigi() {
  ...
  const menu = [
    { id: 'gourd-50', name: 'Gourdasse 50cc', price: 5000, icon: 'flask-purple-atomic' },
    { id: 'gourd-100', name: 'Gourdasse 100cc', price: 10000, icon: 'flask-orange-distill' },
    { id: 'gourd-150', name: 'Gourdasse 150cc', price: 15000, icon: 'flask-green-erlenmeyer' },
  ];
