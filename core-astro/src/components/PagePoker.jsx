                 ...
                 <div className="join-form">
                   ...
                   <div className="join-form-btns">
                     ...
                     <button className="btn-join" style={{ background: 'transparent', boxShadow: 'none', padding: 0 }} onClick={handleJoinRoom} disabled={joinCode.length < 4}>
                       <NeonIcon name="poker-neon-sub" size={80} />
                     </button>
                   </div>
                 </div>
               ) : lobbyView === 'create' ? (
           ...
           <AnimatePresence>
             {pokerState.prizePool > 0 && (
               ...
               >
                  ...
                  <div className="jackpot-amount">{pokerState.prizePool} <NeonIcon name="coin-gold" size={22} /></div>
               ...
               {pokerState.status === 'ENDED' && pokerState.winners.includes(username) && (
                  ...
                  >
                     <div className="win-content">
                        ...
                        <h2 className="win-amount">+{pokerState.prizePool} <NeonIcon name="coin-gold" size={18} /></h2>
